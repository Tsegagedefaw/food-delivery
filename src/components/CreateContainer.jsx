...
export const CreateContainer = () => {
  ...
  const saveDetails = ()=>{
    ...
    try {
      ...
      if(!title || !calories || img === null || !price || !category){
      ...
      flex flex-col items-center justify-center gap-4'>
        {
          fields &&(
            <motion.p
              ...
              animate={{opacity:1}}
              exit={{opacity:0}}
              className={`w-fll p-2 rounded-lg text-center text-lg font-semibold 
                          ${
                            alertstatus === 'danger'
            ...
            {isLoading ? <Loader/>: <>
                   {
                    ...
                    justify-center cursor-pointer">
                      ...
                      accept="image/*" onChange={uploadImage} className='w-0 h-0'/>
                    </label>
                    </>:
                    <>
          ...
          <div className='flex items-center w-full'>
              ...
              md:ml-auto w-full md:w-auto border-none outline-none
              bg-emerald-500 px-12 py-2 rounded-lg text-lg text-white
              font-semibold' onClick={saveDetails}>
              Save
              </button>
          </div>
      </div>
